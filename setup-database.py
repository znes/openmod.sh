...
#                 "geom": "POINT(9.5 54.2)",
#                 "sequences": {"profile": [2,3,4,5]}},
#              {"name": "line1", "type": "line", "tags": {"r": 0.01, "x": 0.1, "I": 2000},
#                 "predecessors": ["bus1"], "successors": ["bus2"],
#                 "geom": "LINESTRING(9.6 54.1, 9.8 54.1)"},
#              {"name": "line2", "type": "line", "tags": {"r": 0.01, "x": 0.1, "I": 1500},
#                 "predecessors": ["bus1"], "successors": ["bus2"],
#                 "geom": "LINESTRING(9.6 54.2, 9.8 54.2)"},
#              {"name": "line3", "type": "line", "tags": {"r": 0.01, "x": 0.1, "I": 2100},
#                 "predecessors": ["bus1"], "successors": ["bus2"],
#                 "geom": "LINESTRING(9.6 54.3, 9.8 54.3)"},
#              {"name": "load1", "type": "load", "tags": {"p_set": 100},
#                 "predecessors": ["bus2"],
#                 "geom": "POINT(9.9 54.2)",
#                 "sequences": {"profile": [1,2,3,4]}}]
...
#for e in json_input:
#    tags = [oms.Tag(k,v) for k,v in e.get('tags', {}).items()]
#    sequences = [oms.Sequence(k,v) for k,v in e.get('sequences', {}).items()]
